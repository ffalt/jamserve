...
let SubsonicListsApi = class SubsonicListsApi {
    ...
    async getAlbumList(query, { orm, user }) {
        ...
        switch (query.type) {
            case 'random':
                folders = (await orm.Folder.findListFilter(ListType.random, undefined, { folderTypes: FolderTypesAlbum }, undefined, { skip, take }, user)).items;
                break;
            case 'starred':
                folders = (await orm.Folder.findListFilter(ListType.faved, undefined, { folderTypes: FolderTypesAlbum }, undefined, { skip, take }, user)).items;
                break;
            case 'frequent':
                folders = (await orm.Folder.findListFilter(ListType.frequent, undefined, { folderTypes: FolderTypesAlbum }, undefined, { skip, take }, user)).items;
                break;
            case 'recent':
                folders = (await orm.Folder.findListFilter(ListType.recent, undefined, { folderTypes: FolderTypesAlbum }, undefined, { skip, take }, user)).items;
                break;
            case 'highest':
                folders = (await orm.Folder.findListFilter(ListType.highest, undefined, { folderTypes: FolderTypesAlbum }, undefined, { skip, take }, user)).items;
                break;
            case 'newest':
    ...
    async getAlbumList2(query, { orm, user }) {
        ...
        switch (query.type) {
            case 'random':
                albums = (await orm.Album.findListFilter(ListType.random, undefined, { rootIDs }, undefined, { skip, take }, user)).items;
                break;
            case 'starred':
                albums = (await orm.Album.findListFilter(ListType.faved, undefined, { rootIDs }, undefined, { skip, take }, user)).items;
                break;
            case 'frequent':
                albums = (await orm.Album.findListFilter(ListType.frequent, undefined, { rootIDs }, undefined, { skip, take }, user)).items;
                break;
            case 'recent':
                albums = (await orm.Album.findListFilter(ListType.recent, undefined, { rootIDs }, undefined, { skip, take }, user)).items;
                break;
            case 'highest':
                albums = (await orm.Album.findListFilter(ListType.highest, undefined, { rootIDs }, undefined, { skip, take }, user)).items;
                break;
            case 'byGenre':
