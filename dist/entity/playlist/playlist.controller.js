...
let PlaylistController = class PlaylistController extends base_controller_1.BaseController {
    async id(id, playlistArgs, trackArgs, episodeArgs, user) {
        return this.transform.playlist(await this.orm.Playlist.oneOrFailFilter({ ids: [id] }, user), playlistArgs, trackArgs, episodeArgs, user);
    }
    ...
    async search(page, playlistArgs, trackArgs, episodeArgs, filter, order, list, user) {
        if (list.list) {
            return await this.orm.Playlist.findListTransformFilter(list.list, filter, [order], page, user, o => this.transform.playlist(o, playlistArgs, trackArgs, episodeArgs, user));
        }
        return await this.orm.Playlist.searchTransformFilter(filter, [order], page, user, o => this.transform.playlist(o, playlistArgs, trackArgs, episodeArgs, user));
    }
    async entries(page, trackArgs, episodeArgs, filter, order, user) {
        const playlistIDs = await this.orm.Playlist.findIDsFilter(filter, user);
        return await this.orm.PlaylistEntry.searchTransformFilter({ playlistIDs }, [order], page, user, o => this.transform.playlistEntry(o, trackArgs, episodeArgs, user));
    }
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [playlist_args_1.PlaylistFilterArgs, user_1.User]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:paramtypes", [base_args_1.PageArgs,
        ...
        episode_args_1.IncludesEpisodeArgs,
        playlist_args_1.PlaylistFilterArgs,
        playlist_entry_args_1.PlaylistEntryOrderArgs,
        user_1.User]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [playlist_args_1.PlaylistMutateArgs,
        user_1.User]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, playlist_args_1.PlaylistMutateArgs,
        user_1.User]),
    __metadata("design:returntype", Promise)
