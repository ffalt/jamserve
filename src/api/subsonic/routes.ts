...
export function registerApi(register: Register, api: SubsonicApi): void {
	...
	register.all('/createPodcastChannel.view', ['podcast'], async (req, res) => {
	...
	register.all('/createShare.view', ['share'], async (req, res) => {
	...
	register.all('/createUser.view', ['admin'], async (req, res) => {
	...
	register.all('/deleteInternetRadioStation.view', ['admin'], async (req, res) => {
			const options: ApiOptions<SubsonicParameters.ID> = {query: req.query, user: req.user, client: req.client};
	...
	register.all('/deletePodcastChannel.view', ['podcast'], async (req, res) => {
			const options: ApiOptions<SubsonicParameters.ID> = {query: req.query, user: req.user, client: req.client};
			await api.deletePodcastChannel(options);
			await ApiResponder.ok(req, res);
	});

	register.all('/deletePodcastEpisode.view', ['podcast'], async (req, res) => {
			const options: ApiOptions<SubsonicParameters.ID> = {query: req.query, user: req.user, client: req.client};
	...
	register.all('/deleteUser.view', ['admin'], async (req, res) => {
	...
	register.all('/downloadPodcastEpisode.view', ['podcast'], async (req, res) => {
			const options: ApiOptions<SubsonicParameters.ID> = {query: req.query, user: req.user, client: req.client};
	...
	register.all('/createInternetRadioStation.view', ['admin'], async (req, res) => {
	...
	register.all('/updateInternetRadioStation.view', ['admin'], async (req, res) => {
	...
	register.all('/getUsers.view', ['admin'], async (req, res) => {
			const options: ApiOptions<{}> = {query: req.query, user: req.user, client: req.client};
	...
	register.all('/jukeboxControl.view', ['jukebox'], async (req, res) => {
	...
	register.all('/refreshPodcasts.view', ['podcast'], async (req, res) => {
			const options: ApiOptions<{}> = {query: req.query, user: req.user, client: req.client};
	...
	register.all('/updateUser.view', ['admin'], async (req, res) => {
