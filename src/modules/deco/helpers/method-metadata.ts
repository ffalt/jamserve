...
export function getMethodMetadata(prototype: object, propertyKey: string | symbol, defaultReturnTypeFormat: string, route?: string, returnTypeFunction?: ReturnTypeFunction, options: MethodOptions = {}): MethodMetadata {
