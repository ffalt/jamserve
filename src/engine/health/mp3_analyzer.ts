import {IID3V1, IMP3, MP3} from 'jamp3';
import {findId3v2FrameDef} from 'jamp3/dist/lib/id3v2/id3v2_frames';
...
export interface IMP3AnalyzerOptions {
	...
	id3v2: boolean;
	id3v1: boolean;
	ignoreOneOfErrorXingCount?: boolean;
}
...
export class MP3Analyzer {
	...
	async read(filename: string, options: IMP3AnalyzerOptions): Promise<IMP3Report> {
		...
		if (head && options.xing) {
			...
			if (!options.ignoreOneOfErrorXingCount &&
