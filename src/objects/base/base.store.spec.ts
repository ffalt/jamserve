...
import {TestDB, TestDBs} from '../../db/db.mock';
...
export function testStore(init: (db: TestDB) => BaseStore<DBObject, SearchQuery>, generateMockObjects: () => Array<DBObject>, generateMatchingQueries: (obj: any) => Array<SearchQuery>, tests: () => void) {
