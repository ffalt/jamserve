...
*   Database Support for SQLite (planned: some more supported by https://mikro-orm.io )
...
run via tsnode which is faster, but nodejs worker_threads can't be used (extended audio module functions)
